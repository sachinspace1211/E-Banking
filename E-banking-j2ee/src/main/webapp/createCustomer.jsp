              ...
              <h3 id="details-heading">Enter the details</h3>
				<form action="EmployeeServlet" method="post">
					<table>
						<tr>
							<td>First Name:</td>
							<td><input type="text" maxlength="32" pattern="[A-Za-z]{1,32}" name="firstName" required="required" /></td>
						</tr>
						<tr>
							<td>Last Name:</td>
							<td><input type="text" maxlength="32" pattern="[A-Za-z]{1,32}"" name="lastName" required="required"/></td>
						</tr>
						<tr>
							<td>Age:</td>
							<td><input type="number" min="18" max="120" name="age" required="required" /></td>
						</tr>
						<tr>
							<td>Gender:</td>
						...
						<tr>
							<td>Occupation:</td>
							<td><input type="text"  pattern="[A-Za-z]{1,32}" name="occupation" /></td>
						</tr>
						<tr>
							<td>Email:</td>
						...
						<tr>
							...
							<td><input type="text" name="contact" title="Enter 10 digit number" pattern="[1-9]{1}[0-9]{9}" required="required"/></td>
						</tr>
						<tr>
							<td>Annual Income:</td>
							<td><input type="number" min="0" max="9223372036854775807" name="annualIncome" required="required" /></td>
						</tr>
						<tr>
							<td>Account Type:</td>

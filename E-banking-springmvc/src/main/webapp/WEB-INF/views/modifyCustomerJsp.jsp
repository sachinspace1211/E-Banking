...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-1">
				<form action="modifyCustomerJsp" method="post" id="form1">
					<table>
						<tr>
							<td>Select ID:</td>
					...
					<table>
						<c:forEach var="row" items="${result.rows}">
							...
							<tr>
								<td>Last Name:</td>
								<td><input type="text" maxlength="32"
									pattern="[A-Za-z]{1,32}" name="lastName"
							...
							<tr>
								...
								<td><input type="text" pattern="[A-Za-z]{1,32}"
									value="${row.city}" name="city" /></td>
							</tr>
							<tr>
								<td>Occupation:</td>
								<td><input type="text" pattern="[A-Za-z]{1,32}"
									value="${row.occupation}" name="occupation" /></td>
							</tr>
							<tr>
								<td>Email:</td>
							...
							<tr>
								...
								<td><input type="text" name="contact"
									title="Enter 10 digit number" value="${row.contact}"
									pattern="[1-9]{1}[0-9]{9}" required="required" /></td>
							</tr>
							<tr>
								<td>Annual Income:</td>
								<td><input type="number" min="0" max="9223372036854775807"
									name="annualIncome" value="${row.annualIncome}"
